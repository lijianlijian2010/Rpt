...
class Reportlab:
    def makeForm(self, bug_list, No_bug_list, cmdOpts):
        ...
        print "Jian: 3"
        # bug list table
        text = '<para autoLeading="off" fontSize=9 align=center><br/><b>2. Bug List</b><br/></para>'
        story.append(Paragraph(text,normalStyle))
        ...
        print "Jian: 5"
        # no bug list table
        text = '<para autoLeading="off" fontSize=9 align=center><br/><b>3.Failed cases with no Bug Linked</b><br/></para>'
...
def main(args):
    try:
        ...
        with open('10_7.json', 'w') as fh:
            json.dump(Bug_list, fh)

        with open('10_7.json', 'r') as fh:
            b2 = json.load(fh)
